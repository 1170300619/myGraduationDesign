...
Triangle::Triangle(const std::vector<Vertex> &vertices, int v_0, int v_1, int v_2)
{
    vertex_0 = v_0;
    vertex_1 = v_1;
    vertex_2 = v_2;
...
{
    const Vertex &v0 = mesh->vertices[vertex_0];
    const Vertex &v1 = mesh->vertices[vertex_1];
    const Vertex &v2 = mesh->vertices[vertex_2];
